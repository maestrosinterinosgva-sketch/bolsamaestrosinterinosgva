...
Permite subir automáticamente 'interinos_web.zip' a tu web de Netlify mediante su API oficial.
"""
import os
import sys
import json
...
def deploy_zip_to_netlify(zip_path="interinos_web.zip"):
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "Interinos-Deployer/1.0"
        },
        method="POST"
    )
